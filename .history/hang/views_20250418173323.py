...
def get_random_questions(num_questions=10):
    ...
    for question in selected_questions:
        ...
        if isinstance(question, MCQQuestion):
            ...
            q_dict.update({
                'correct_answer': 'true' if question.correct_answer else 'false'  # Convert to string for JavaScript
            })
...
def game(request):
    ...
    context = {
        ...
        'player_stats': stats,
        'questions_json': json.dumps(questions, cls=DjangoJSONEncoder),  # Serialize questions properly
